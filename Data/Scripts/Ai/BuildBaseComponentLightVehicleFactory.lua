...
function Definitions()
	...
	{
		"BaseForce",
		"E_Ground_Light_Vehicle_Factory | R_Ground_Light_Vehicle_Factory | Early_Empire_Light_Vehicle_Factory | Terrorists_Ground_Light_Vehicle_Factory | CIS_Remnant_Ground_Light_Vehicle_Factory | Trade_Federation_Light_Vehicle_Factory | Commerce_Guild_Light_Vehicle_Factory | Techno_Union_Light_Vehicle_Factory | Banking_Clan_Light_Vehicle_Factory | Mandalorians_Ground_Light_Vehicle_Factory | Galactic_Empire_Ground_Light_Vehicle_Factory | Rebel_Alliance_Ground_Light_Vehicle_Factory | Pyke_Syndicate_Ground_Light_Vehicle_Factory | Corporate_Sector_Ground_Light_Vehicle_Factory | Hapan_Consortium_Ground_Light_Vehicle_Factory | Crimson_Dawn_Ground_Light_Vehicle_Factory | Black_Sun_Ground_Light_Vehicle_Factory | Hutt_Cartel_Ground_Light_Vehicle_Factory | New_Republic_Ground_Light_Vehicle_Factory | Remnant_Rax_Ground_Light_Vehicle_Factory | Remnant_Gratloe_Ground_Light_Vehicle_Factory | Remnant_Loring_Ground_Light_Vehicle_Factory | Remnant_Adelhard_Ground_Light_Vehicle_Factory | First_Order_Sector_Ground_Light_Vehicle_Factory | Chiss_Ascendancy_Sector_Ground_Light_Vehicle_Factory = 1"
	}
	}
